...
def main():
    ...
    filename = 'kv-costs-net.png'


    # choosenData = 2
    # yaxis = 'IO Usage (MB)'
    # filename = 'kv-costs-io.png'




    notLog3kvA = ExtractFunc('3apps-monit/notlog/app1/io.out', choosenData)
    notLog3kvB = ExtractFunc('3apps-monit/notlog/app2/io.out', choosenData)
    notLog3kvC = ExtractFunc('3apps-monit/notlog/app3/io.out', choosenData)
    acuNotLog3kv = SumOfLists([notLog3kvA, notLog3kvB, notLog3kvC])



    coupLog3kvA = ExtractFunc('3apps-monit/applog/app1/io.out', choosenData)
    coupLog3kvB = ExtractFunc('3apps-monit/applog/app2/io.out', choosenData)
    coupLog3kvC = ExtractFunc('3apps-monit/applog/app3/io.out', choosenData)
    acuCoupLog3kv = SumOfLists([coupLog3kvA, coupLog3kvB, coupLog3kvC])



    decoupLog3kvA = ExtractFunc('3apps-monit/decouplog/app1/io.out', choosenData)
    decoupLog3kvB = ExtractFunc('3apps-monit/decouplog/app2/io.out', choosenData)
    decoupLog3kvC = ExtractFunc('3apps-monit/decouplog/app3/io.out', choosenData)
    acuDecoupLog3kv = SumOfLists([decoupLog3kvA, decoupLog3kvB, decoupLog3kvC])

    logger3kvA = ExtractFunc('3apps-monit/decouplog/logger1/io.out', choosenData)
    logger3kvB = ExtractFunc('3apps-monit/decouplog/logger2/io.out', choosenData)
    ...
    coupLog6kvB = ExtractFunc('6app/applog/app1/io.out', choosenData)
    ...
    logger6kvA = ExtractFunc('6app/decouplog/loggersCosts/logger1/io.out', choosenData)
    logger6kvB = ExtractFunc('6app/decouplog/loggersCosts/logger2/io.out', choosenData)
    ...
    ax.bar(xlabels - width, costsNotlog, width, label='kvstore')
    ax.bar(xlabels, costsApplog, width, label='kvstore-level logging')
    ax.bar(xlabels + width, costsDecoup, width, label='kvstore with decoupled logging')
